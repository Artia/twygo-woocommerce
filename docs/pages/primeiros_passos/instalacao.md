...
### Requisito para instalação
É necessário ter o plugin do WooCommerce instalado e configurado corretamente no site antes da adição do plugin da twygo.

### Onde baixar?
O plugin pode ser baixado
[clicando aqui](https://github.com/Artia/twygo-woocommerce/releases/tag/1.0.4) ou [diretamente aqui](https://github.com/Artia/twygo-woocommerce/releases/download/1.0.4/twygo-woocommerce.zip).
